...
|---|---|---|---|---|---|
| TASK-016 | Daily Review | Add report-only historical PnL audit for Daily Review against local IBKR archive | Branch `agent/TASK-016-daily-review-pnl-audit`; worktree `../rubicon-worktrees/agent-TASK-016-daily-review-pnl-audit` | in_progress | Implementing CLI/report audit; preserve live-board rows for TASK-013 through TASK-015. |
