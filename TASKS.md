...
| TASK-007 | General / Docs and Runtime | Deprecate old AI STUFF Rubicon folders and update mirror env defaults | Branch `agent/TASK-007-docs-runtime`; current Desktop mirror | ready_for_merge | Committed task branch is ready for merge via the landing workflow. |
