...
|---|---|---|---|---|---|
| TASK-007 | General / Docs and Runtime | Deprecate old AI STUFF Rubicon folders and update mirror env defaults; strengthen acceptance/validation proof rules; add newest-first table rules | Branch `agent/TASK-007-docs-runtime`; current Desktop mirror | ready_for_merge | Work commit `0831124`; ready-for-merge marker committed on branch; docs validation passed. |
